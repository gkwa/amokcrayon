...
func (m *Amokcrayon) ExtractGPSMetadata(ctx context.Context) (string, error) {
	imageUrls := []string{
		...
		"https://alpinesecurity.com/wp-content/uploads/2020/02/EXIF+Quick+View+sample.JPG",
		"https://s3.amazonaws.com/mertonium_public/cable_car_og.jpg",
		"https://miro.medium.com/v2/resize:fit:4800/format:webp/1*jYXzZpwqzGFEk9qKOt436A.png",
	}
