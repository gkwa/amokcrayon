...
import (
	...
	"github.com/gkwa/amokcrayon/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.amokcrayon.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".amokcrayon")
	}
